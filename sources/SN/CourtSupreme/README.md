# SN/CourtSupreme — Senegal Supreme Court (Cour Suprême)

Senegal Supreme Court decisions sourced from Juricaf (AHJUCAF francophone court
decisions database). ~7,459 decisions.

- **Source**: https://juricaf.org
- **Format**: JSON API (listing) + HTML (full text)
- **Coverage**: ~7,459 decisions
- **Language**: French
- **Data type**: case_law

## How it works

1. Queries the Juricaf JSON API for paginated Senegal Supreme Court decision listings
