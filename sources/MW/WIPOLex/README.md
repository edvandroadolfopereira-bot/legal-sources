# MW/WIPOLex — Malawi Legislation (WIPO Lex)

Full text of the Republic of Malawi's intellectual-property and IP-related
statutes from the **WIPO Lex** database (https://www.wipo.int/wipolex/), WIPO's
free, open gateway to the laws of ~200 jurisdictions.

## What this covers

The WIPO Lex Malawi member profile lists the country's industrial-property and
copyright acts and regulations, plus related commercial law: patents, trade
marks, registered designs, copyright and neighbouring rights, plant breeders'
rights, electronic transactions and competition statutes. All texts are in
English (Malawi's legislative language).
...
MalawiLII platform (a Laws.Africa / LII site whose document pages block
datacenter IPs and carry a CC BY-NC restriction). WIPO Lex publishes
machine-readable Malawi statute text without authentication and is a stable,
commercially-usable external full-text source.

## How it works

1. Fetch the server-rendered member profile
   (`/wipolex/en/members/profile/MW`) and parse each legal text's adoption
...
documents are official legislative texts of the Republic of Malawi (acts,
